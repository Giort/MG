...
class ModalWindowChecker:
    ...
    def check_main_page(self) -> List[bool]:
        ...
        checks = [
            ...
            ('(//*[@id="promo-modal1-3"]//*[@value="callback_main_promo_club_lake"])[1]',
             'главная, модалка на баннере "Клубные поселки", lgForm'),
            ('(//*[@id="modal_syn-48"]//*[@value="lg_main_catalog_patriot"])[1]',
             'главная, модалка син_48 (Парк Патриот) в блоке "Лучшие поселения", lgForm'),
            ('(//*[@id="modal_syn-53"]//*[@value="lg_main_catalog_new_gizn"])[1]',
             'главная, модалка син_53 (Новая жизнь) в блоке "Лучшие поселения", lgForm'),
            ('(//*[@id="modal_syn-63"]//*[@value="lg_main_catalog_usadba_v_podmoskovie"])[1]',
             'главная, модалка син_425 (Экополис) в блоке "Лучшие поселения", lgForm'),
