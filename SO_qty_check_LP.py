...
# except:
#     print("ERROR: не получилось посчитать СП на син_9")
...
# except:
#     print("ERROR: не получилось посчитать СП на син_24")
...
try:
    ...
    print("ERROR: не получилось посчитать СП на син_33")
...
try:
    ...
    print("ERROR: не получилось посчитать СП на син_34")
...
try:
    ...
    print("ERROR: не получилось посчитать СП на син_37")
...
try:
    ...
    print("ERROR: не получилось посчитать СП на син_42")
...
try:
    ...
    print("ERROR: не получилось посчитать СП на син_53")
...
try:
    ...
    print("ERROR: не получилось посчитать СП на син_84")
...
try:
    ...
    print("ERROR: не получилось посчитать СП на син_85")
...
try:
    ...
    print("ERROR: не получилось посчитать СП на син_87")
...
try:
    ...
    print("ERROR: не получилось посчитать СП на син_89")
