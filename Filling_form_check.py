...
# 1. проверка формы "Хотите узнать подробнее о проекте?"
...
# 2. проверка формы "Получите каталог посёлков"
...
# 3. проверка формы "Подпишитесь на рассылку"
...
# 4. проверка формы "Подпишитесь на рассылку"
