...
#     name.send_keys(str(data["submit_data_prod"]["name"]))
#     driver.find_element(by=By.XPATH, value='//*[@class="uk-modal w-modal-callback uk-open"]//*[@id="consultationform-phone"]').send_keys(str(data["submit_data_prod"]["phone"]))
#     driver.find_element(by=By.XPATH, value='//*[@class="uk-modal w-modal-callback uk-open"]//*[@id="consultationform-email"]').send_keys(str(data["submit_data_prod"]["email"]))
...
#     print('   OK: syn_84 модалка в 1-м баннере')
# except:
#     print('ERROR: что-то не так с модалкой в 1-м баннере на син_84')
...
try:
    ...
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal w-modal-callback uk-open"]//*[@type="submit"]').click()
    wait(driver, 14).until(EC.visibility_of_element_located((By.XPATH, '//*[@class="uk-modal w-modal-callback uk-open"]//*[text()[contains(., "Заявка отправлена")]]')))
    print('   OK: syn_84 модалка в блоке "МР - это"')
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal w-modal-callback uk-open"]/div/div/button').click()
except:
    print('ERROR: что-то не так с модалкой в блоке "МР - это" на син_84')
...
try:
    ...
    name.send_keys(str(data["submit_data_prod"]["name"]))
    driver.find_element(by=By.XPATH, value='//*[@class="w-modal-description uk-modal uk-open"]//*[@id="consultationform-phone"]').send_keys(str(data["submit_data_prod"]["phone"]))
    driver.find_element(by=By.XPATH, value='//*[@class="w-modal-description uk-modal uk-open"]//*[@id="consultationform-email"]').send_keys(str(data["submit_data_prod"]["email"]))
    ...
    print('   OK: syn_84 модалка в блоке "Категории участков"')
...
try:
    ...
    name.send_keys(str(data["submit_data_prod"]["name"]))
    driver.find_element(by=By.XPATH, value='//*[@id="modal-zir"]//*[@id="consultationform-phone"]').send_keys(str(data["submit_data_prod"]["phone"]))
    driver.find_element(by=By.XPATH, value='//*[@id="modal-zir"]//*[@id="consultationform-email"]').send_keys(str(data["submit_data_prod"]["email"]))
    ...
    print('   OK: syn_84 модалка в блоке "Зона интенсивного развития"')
    driver.find_element(by=By.XPATH, value='//*[@id="modal-zir"]/div/div/button').click()
except:
    print('ERROR: что-то не так с модалкой в блоке "Зона интенсивного развития" на син_84')
...
try:
    ...
    name.send_keys(str(data["submit_data_prod"]["name"]))
    driver.find_element(by=By.XPATH, value='//*[@id="modal-stay"]//*[@id="consultationform-phone"]').send_keys(str(data["submit_data_prod"]["phone"]))
    driver.find_element(by=By.XPATH, value='//*[@id="modal-stay"]//*[@id="consultationform-email"]').send_keys(str(data["submit_data_prod"]["email"]))
...
try:
    ...
    name.send_keys(str(data["submit_data_prod"]["name"]))
    driver.find_element(by=By.XPATH, value='//div[text()[contains(., "Получите схему")]]//parent::div//*[@id="consultationform-phone"]').send_keys(str(data["submit_data_prod"]["phone"]))
    driver.find_element(by=By.XPATH, value='//div[text()[contains(., "Получите схему")]]//parent::div//*[@id="consultationform-email"]').send_keys(str(data["submit_data_prod"]["email"]))
    ...
    print('   OK: syn_84 форма "Получите схему проезда"')
except:
    print('ERROR: что-то не так с формой "Получите схему проезда" на син_84')

# модалка в "Бизнес-планах"
try:
    driver.refresh() # потому что такая модалка уже была заполнена ранее
    wait(driver, 10).until(lambda driver: driver.execute_script('return document.readyState') == 'complete')
    ...
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal w-modal-callback uk-open"]//*[@type="submit"]').click()
    wait(driver, 14).until(EC.visibility_of_element_located((By.XPATH, '//*[@class="uk-modal w-modal-callback uk-open"]//*[text()[contains(., "Заявка отправлена")]]')))
    print('   OK: syn_84 модалка в "Бизнес-планах"')
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal w-modal-callback uk-open"]/div/div/button').click()
except:
    print('ERROR: что-то не так с модалкой в "Бизнес-планах" на син_84')
...
try:
    ...
    actions.move_to_element(name).perform()
    name.send_keys(str(data["submit_data_prod"]["name"]))
    driver.find_element(by=By.XPATH, value='//div[text()[contains(., "Получите презентацию")]]//parent::div//*[@id="consultationform-phone"]').send_keys(str(data["submit_data_prod"]["phone"]))
    driver.find_element(by=By.XPATH, value='//div[text()[contains(., "Получите презентацию")]]//parent::div//*[@id="consultationform-email"]').send_keys(str(data["submit_data_prod"]["email"]))
    ...
    print('   OK: syn_84 форма "Получите презентацию"')
except:
    print('ERROR: что-то не так с формой "Получите презентацию" на син_84')
...
try:
    ...
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal w-modal-callback uk-open"]//*[@type="submit"]').click()
    wait(driver, 14).until(EC.visibility_of_element_located((By.XPATH, '//*[@class="uk-modal w-modal-callback uk-open"]//*[text()[contains(., "Заявка отправлена")]]')))
    print('   OK: syn_84 модалка в "Господдержке"')
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal w-modal-callback uk-open"]/div/div/button').click()
except:
    print('ERROR: что-то не так с модалкой в "Господдержке" на син_84')
...
try:
    ...
    name.send_keys(str(data["submit_data_prod"]["name"]))
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal uk-open"]//*[@id="consultationform-phone"]').send_keys(str(data["submit_data_prod"]["phone"]))
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal uk-open"]//*[@id="consultationform-email"]').send_keys(str(data["submit_data_prod"]["email"]))
    ...
    print('   OK: syn_84 модалка в "Сохраните сбережения"')
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal uk-open"]/div/div/button').click()
except:
    print('ERROR: что-то не так с модалкой в "Сохраните сбережения" на син_84')
...
try:
    ...
    name.send_keys(str(data["submit_data_prod"]["name"]))
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal w-uk-form uk-open"]//*[@id="consultationform-phone"]').send_keys(str(data["submit_data_prod"]["phone"]))
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal w-uk-form uk-open"]//*[@id="consultationform-email"]').send_keys(str(data["submit_data_prod"]["email"]))
    ...
    print('   OK: syn_84 модалка в "Не упусти свой шанс"')
    driver.find_element(by=By.XPATH, value='//*[@class="uk-modal w-uk-form uk-open"]/div/div/button').click()
except:
    print('ERROR: что-то не так с модалкой в "Не упусти свой шанс" на син_84')
...
try:
    ...
    actions.move_to_element(name).perform()
    name.send_keys(str(data["submit_data_prod"]["name"]))
    driver.find_element(by=By.XPATH, value='//div[text()[contains(., "Действуйте")]]//parent::div//*[@id="consultationform-phone"]').send_keys(str(data["submit_data_prod"]["phone"]))
    driver.find_element(by=By.XPATH, value='//div[text()[contains(., "Действуйте")]]//parent::div//*[@id="consultationform-email"]').send_keys(str(data["submit_data_prod"]["email"]))
    ...
    print('   OK: syn_84 форма "Действуйте"')
except:
    print('ERROR: что-то не так с формой "Действуйте" на син_84')
