...
def main():
    ...
    try:
        ...
        check_main_page_tour(driver, actions, tour_number=1, balloon_index=1, z_index_value='3101')
        check_main_page_tour(driver, actions, tour_number=2, balloon_index=2, z_index_value='308')
